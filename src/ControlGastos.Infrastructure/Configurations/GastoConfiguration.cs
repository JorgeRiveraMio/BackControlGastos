...
public sealed class GastoConfiguration : IEntityTypeConfiguration<Gasto>
{
    public void Configure(EntityTypeBuilder<Gasto> builder)
    {
        ...
        builder.Property(gasto => gasto.CodigoEstado).HasColumnName("cod_estado").HasMaxLength(20).IsRequired();
        ...
        builder.Property(gasto => gasto.NombreComercio).HasColumnName("nom_comercio").HasMaxLength(150).IsRequired();
        builder.Property(gasto => gasto.Descripcion).HasColumnName("des_gasto").HasMaxLength(300).IsRequired();
        builder.Property(gasto => gasto.CodigoOrigen).HasColumnName("cod_origen").HasMaxLength(20).IsRequired();
        builder.Property(gasto => gasto.RutaComprobante).HasColumnName("rut_comprobante").HasMaxLength(500).IsRequired();
        builder.Property(gasto => gasto.NombreComprobante).HasColumnName("nom_comprobante").HasMaxLength(250).IsRequired();
